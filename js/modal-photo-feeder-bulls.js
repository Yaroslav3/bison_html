...
function show_foto_feeder_bulls_one()
{
    ...
    if (widthOfBrows >= 981) { 
        $('#overlay').fadeIn(400, 
                function(){ 
                    ...
                    $.ajax({
                        type: 'GET',
                        url: 'http://admin.pristinebison.com/feeder_bulls_photo',
...
function show_foto_feeder_bulls_two()
{
    let widthOfBrows = window.innerWidth;
    if (widthOfBrows >= 981) {
        $('#overlay').fadeIn(400, 
 ...
 function show_foto_feeder_bulls_three()
{
    let widthOfBrows = window.innerWidth;
    if (widthOfBrows >= 981) {
        $('#overlay').fadeIn(400, 
 ...
 function show_foto_feeder_bulls_four()
{
    let widthOfBrows = window.innerWidth;
    if (widthOfBrows >= 981) {
        $('#overlay').fadeIn(400, 
 ...
 function show_foto_feeder_bulls_five()
{
    let widthOfBrows = window.innerWidth;
    if (widthOfBrows >= 981) {
        $('#overlay').fadeIn(400, 
...
function show_foto_feeder_bulls_six()
{
    let widthOfBrows = window.innerWidth;
    if (widthOfBrows >= 981) {
        $('#overlay').fadeIn(400, 
