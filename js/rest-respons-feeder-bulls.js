$(document).ready(function() {
    ...
    $.ajax({
        type: 'GET',
        url: 'http://admin.pristinebison.com/feeder_bulls_text',
        success: function (orders) {
            $.each(orders, function (i, data) {
    ...
    let editor = new Quill('#editor-feeder-bulls', options);

    function getData() {

        $.ajax({
            url: 'http://admin.pristinebison.com/feeder_bulls_text/editor',
            dataType: 'json',
            type: 'GET',
            success: function (data) {
