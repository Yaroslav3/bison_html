$(document).ready(function() {
    ...
    $.ajax({
     ...
     $.ajax({
         type: 'GET',
         url: 'http://admin.pristinebison.com/replacement_females_text',
         success: function (orders) {
             $.each(orders, function (i, data) {
    ...
    let editor = new Quill('#editor-replacement-females', options);

    function getData() {

        $.ajax({
            url: 'http://admin.pristinebison.com/replacement_females_text/editor',
            dataType: 'json',
            type: 'GET',
            success: function (data) {
