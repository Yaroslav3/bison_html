$(document).ready(function() {
    ...
    $.ajax({
        type: 'GET',
        url: 'http://admin.pristinebison.com/feeder_females_text',
        success: function (orders) {
            $.each(orders, function (i, data) {
 ...
 const options = {
    ...
    let editor = new Quill('#editor-feeder-females', options);

    function getData() {

        $.ajax({
            url: 'http://admin.pristinebison.com/feeder_females_text/editor',
            dataType: 'json',
            type: 'GET',
            success: function (data) {
